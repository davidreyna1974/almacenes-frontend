...
| Campo | Valor |
|---|---|
| **Ronda activa** | **Ronda 8 — Reportes ✅ CERTIFICADO (2026-06-27)** — Fase 1: **96 PASS · 0 FAIL · 0 PENDIENTE · 13 N/A · 0 bugs** (código congelado). Fase 4 PASS: `ng build` 0 errores AOT, `ng test` 456 specs 0 fallos 88.94% statements, `mvn test` 405 tests 0 fallos (incluye 61 tests de Reports). SEC/CYBER server-side por rol (paths reales `/reports/dashboard/executive`, `/reports/operations/pending`, `/reports/sales/profitability`...); RBAC sidebar verificado en los 4 roles; VAL/BSRCH con tecleo+calendario. Hallazgo VAL-OPE-02/03 inicial = artefacto de tecleo (adapter de fecha M/d/yyyy) — con calendario el mensaje from>to + botón disabled funcionan. Módulo Reportes CERTIFICADO bajo Propuesta D. _(Ronda 7 — Ventas CERTIFICADO 2026-06-27; Ronda 6 — Inventario CERTIFICADO 2026-06-26; Ronda 5 — Compras CERTIFICADO 2026-06-23.)_ |
